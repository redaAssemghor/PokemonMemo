    ...
    <div className="game-over">
      {win && (
        <div className="win-screen">
          ...
          <img
            className="gif"
            src="https://media2.giphy.com/media/xx0JzzsBXzcMK542tx/giphy.gif"
            alt=""
          />
          <p>
            Your final score is <span className="span">{finalScore}</span>
          </p>
      ...
      {loss && (
        <div className="loss-screen">
          ...
          <img
            className="gif"
            src="https://media.tenor.com/TRTMIXMvMlAAAAAC/ditto-sad.gif"
            alt=""
          />
          <p>
            Your final score is <span className="span">{finalScore}</span>
